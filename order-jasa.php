...
<body>
    ...
    <div class="container">
        ...
        if (isset($_GET['id'])) {
            $id = $_GET['id'];
            $sql_edit = mysqli_query($config, "SELECT * FROM jasa WHERE id='$id'");
            while ($data = mysqli_fetch_array($sql_edit)) {
                $nama_jasa = $data['nama'];
                $harga_jasa = $data['harga'];
                $gambar_jasa = $data['gambar'];
            }
        }
        ?>
        ...
        <form action="order.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="beli" name="beli" value="<?php echo $nama_jasa ?>" readonly>
                    <div class="gambar">
                        <img src="assets/images/<?php echo $gambar_jasa ?>" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="harga" name="harga" value="<?php echo $harga_jasa ?>" readonly>
                </div>
            </div>
            ...
            <center>
                ...
                <a href="jasa.php" class="btn btn-warning ms-3">Batal</a>
            </center>
